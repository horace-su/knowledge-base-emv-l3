...
> "转联机"之后的完整密文一来一回（ARQC 生成 → 发卡行验证 → ARPC 回写 → 发卡行认证 → 脚本 71/72）见 [ARQC / ARPC 联机授权](./ARQC-ARPC联机授权.md)；其 ISO 8583 / Field 55 报文载体见 [ISO 8583 与 Field 55 报文层](./ISO8583与Field55报文层.md)。
